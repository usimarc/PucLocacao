...
namespace Locacao.Migrations
{
    ...
    [Migration("20240920210445_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Locacao.Model.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Locacao.Model.Empresa", b =>
                {
            ...
            modelBuilder.Entity("Locacao.Model.Funcionario", b =>
                {
            ...
            modelBuilder.Entity("Locacao.Model.Locacao", b =>
                {
            ...
            modelBuilder.Entity("Locacao.Model.Veiculo", b =>
                {
                    b.Property<int>("IdVeiculo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Locacao.Model.Locacao", b =>
                {
                    b.HasOne("Locacao.Model.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("IdCliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Locacao.Model.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("IdEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Locacao.Model.Funcionario", "Funcionario")
                        .WithMany()
                        .HasForeignKey("IdFuncionario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Locacao.Model.Veiculo", "Veiculo")
                        .WithMany()
